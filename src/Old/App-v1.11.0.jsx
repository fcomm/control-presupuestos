  ...
  return (
    <details style={{ position: "relative" }}>
      <summary style={{ cursor: "pointer" }}>
        <span style={{ ...inputStyle, display: "inline-flex", alignItems: "center", gap: 8, width: 150, justifyContent: "space-between" }}>
          {label}
        </span>
      </summary>
      <div style={{
...
function TransaccionesTab({ unidad, partidas, transacciones, transaccionesApi }) {
  ...
  const COLUMNAS_TRANS = [
    ...
    { key: "partida", label: "Partida", render: (t) => { const p = partidaDe(t); return p ? p.concepto : <span style={{ color: T.red }}>Partida eliminada</span>; } },
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {sinVincular.length > 0 && (
        <Panel title="Transacciones importadas sin partida vinculada" subtitle={`${sinVincular.length} en ${unidad} — su folio no coincidió con ninguna partida`}>
          ...
          <div style={{ fontSize: 11, color: T.textFaint, marginTop: 10 }}>
            Clic en "Vincular" para abrir el formulario, elegir la partida correcta en el selector y guardar.
          </div>
        </Panel>
      )}
